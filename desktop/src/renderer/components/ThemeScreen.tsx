...
interface Props { onClose: () => void; onSendInput?: (text: string) => void; onOpenMarketplace?: () => void; }

export default function ThemeScreen({ onClose, onSendInput, onOpenMarketplace }: Props) {
